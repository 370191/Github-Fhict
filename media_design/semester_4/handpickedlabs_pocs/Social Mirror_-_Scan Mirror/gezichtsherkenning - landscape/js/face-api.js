(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var FACE_EXPRESSION_LABELS = ['neutraal', 'blij', 'droevig', 'boos', 'bang', 'walgelijk', 'verbaast'];
    ...
    var DrawFaceLandmarksOptions = /** @class */ (function () {
        function DrawFaceLandmarksOptions(options) {
            ...
            this.lineColor = lineColor || 'rgba(255, 0, 0, 1)';
            this.pointColor = pointColor || 'rgba(0, 0, 0, 1)';
        }
